...
class PPO:
    ...
    def update(self, buffer):
        ...
        # Preprocess observations: Ensure they are 4-channel grayscale
        obs_array = obs_array.reshape(-1, 4, 84, 84)  # Reshape to (Batch, Channels, H, W)

        obs = torch.tensor(obs_array, dtype=torch.float32) / 255.0  # Normalize
        ...
        print(f"Returns Shape in Update: {returns.shape}")  # Debug shape
